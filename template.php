            ...
            if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS'])
            {
                ...
                <div class="info_block">
                    <div class="block payment">
                        ...
                        <a href="/oplata/" target="_blank"><img src="<?=SITE_TEMPLATE_PATH?>/images/info_block/pb.png" /></a>
                        <a href="/oplata/" target="_blank"><img src="<?=SITE_TEMPLATE_PATH?>/images/info_block/mc.png" /></a>
                        <a href="/oplata/" target="_blank"><img src="<?=SITE_TEMPLATE_PATH?>/images/info_block/visa.png" /></a>
                        <a href="/oplata/" target="_blank"><img src="<?=SITE_TEMPLATE_PATH?>/images/info_block/wm.png" /></a>
                    </div>
...
?>
    ...
    <style type="text/css">
        ...
        #rightcol {
         ...
         align:center;
         text-align: center;
         background: none repeat scroll 0 0 #8dab66;
         color: #fff;
         }*/
        #rightcol {
            position: relative;
